...
// Versión resumida para la preview del home
export const experiencePreviews = experiences.map((exp) => ({
  title: exp.title.includes("VS Code")
    ? "AI Unit Test Generator"
    : exp.title.includes("SciELO")
      ? "SciELO Article Markup"
      : "Digital Math Journal",
  description: exp.description.split(".")[0] + ".",
  date: exp.startDate.replace("August", "Aug").replace("September", "Sep"),
